...
class EDOS_loader(Dataset):
    def __init__(self, txt_file, dataclass, gray, word_emb):
        ...
        # emodict = {'anger': "anger", 'disgust': "disgust", 'fear': "fear", 'happiness': "happy", 'neutral': "neutral", 'sadness': "sad", 'surprise': "surprise"}
        self.sentidict = {}
#         self.sentidict['positive'] = ['acknowledging', 'trusting', 'confident', 'hopeful', 'caring', 'anticipating', 'wishing']
#         self.sentidict['negative'] = ['angry', 'furious']
#         self.sentidict['neutral'] = ['prepared', 'sentimental']

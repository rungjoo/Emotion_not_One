...
def main():    
    ...
    dataclass_list = ['emotion', 'emotion', 'emotion'] # 'emotion'
    label_softmax_list = [False, True]
    ...
    for dataset, dataclass in zip(dataset_list, dataclass_list):
        ...
        """logging and path"""
        for label_softmax in label_softmax_list:
            if label_softmax:
                label_softmax_type = 'use_label_softmax'
            else:
                label_softmax_type = 'no_label_softmax'
            save_path = os.path.join(dataset+'_models', model_type, dataclass, gray_type, label_softmax_type)        
...
if __name__ == '__main__':
    ...
    parser.add_argument( "--gray", help = 'heuristic or word or teacher', default = 'heuristic')

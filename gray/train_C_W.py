...
from utils_C_W import make_batch_roberta, make_batch_bert, make_batch_gpt
from utils_C_W import make_batch_roberta_ws, make_batch_bert_ws, make_batch_gpt_ws
...
if __name__ == '__main__':
    ...
    parser.add_argument( "--gray", help = 'heuristic or word or word_softmax', default = 'heuristic')
